...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('reg_periksa', function (Blueprint $table) {
            ...
            $table->char('kd_pj', 3)->default('BPJ');
            ...
            // $table->foreign('kd_poli')->references('kd_poli')->on('poliklinik')->onDelete('cascade')->onUpdate('cascade');
            // $table->foreign('kd_dokter')->references('kd_dokter')->on('dokter')->onDelete('cascade')->onUpdate('cascade');
            // $table->foreign('kd_pj')->references('kd_pj')->on('penjab')->onDelete('restrict')->onUpdate('cascade');
            // $table->foreign('no_rkm_medis')->references('no_rkm_medis')->on('pasien')->onDelete('restrict')->onUpdate('cascade');
        });
    }
